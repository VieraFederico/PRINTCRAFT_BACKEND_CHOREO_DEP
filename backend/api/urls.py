...
urlpatterns = [
    ...
    path('mpresponse/success_order/', MercadoPagoSuccessViewOrder.as_view(),name='mercado_pago_notifications'),
    path('mpresponse/success_printrequest/', MercadoPagoSuccessViewPrintRequest.as_view(), name='mercado_pago_notifications'),
    path('mpresponse/success_designrequest/', MercadoPagoSuccessViewDesignRequest.as_view(), name='mercado_pago_notifications'),
