...
urlpatterns = [
    ...
    path('success/order/', MercadoPagoSuccessViewOrder.as_view(),name='mercado_pago_notifications'),
    path('success/printrequest/', MercadoPagoSuccessViewPrintRequest.as_view(), name='mercado_pago_notifications'),
    path('success/designrequest/', MercadoPagoSuccessViewDesignRequest.as_view(), name='mercado_pago_notifications'),
