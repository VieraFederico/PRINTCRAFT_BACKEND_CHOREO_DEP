...
urlpatterns = [
    ...
    path('sellers/<int:user_id>/reviews/', SellerReviewsView.as_view(), name='seller-reviews'),
    path('sellers/<int:user_id>/rating/', SellerRatingView.as_view(), name='seller-rating'),
    path('products/create/', ProductCreateView.as_view(), name='product-create'),
    path('products/delete/<int:product_id>/', DeleteProductView.as_view(), name='delete-product'),
    path('products/', ProductListView.as_view(), name='product-list'),  # Nueva URL para listar todos los productos
    path('products/seller/<int:userId>/', SellerProductListView.as_view(), name='seller-product-list'),
    path('orders/create/', CreateOrderPaymentView.as_view(), name='order-create'),  # Crear una orden
    ...
    path('orders/mine/', UserOrderListView.as_view(), name='user-order-list'),  # Ver mis órdenes
    ...
    path('design-reverse-auction/delete/<int:auction_id>/', DeleteDesignReverseAuctionView.as_view(), name='delete-design-reverse-auction'),
    ...
    path('mpresponse/success/order/', MercadoPagoSuccessViewOrder.as_view(),name='mercado_pago_notifications'),
    path('mpresponse/success/printrequest/', MercadoPagoSuccessViewPrintRequest.as_view(), name='mercado_pago_notifications'),
    path('mpresponse/success/designrequest/', MercadoPagoSuccessViewDesignRequest.as_view(), name='mercado_pago_notifications'),
    ...
    path('mp/refresh/', MercadoPagRefresh.as_view(), name='testing_mp_token'),
